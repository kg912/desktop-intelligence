...
function AboutPanel() {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-base font-semibold text-content-primary mb-1">Desktop Intelligence</h2>
        <p className="text-sm text-content-muted">Local Inference. Zero Latency.</p>
      </div>
  ...
  return (
    <div className="flex h-full w-full" style={{ background: '#0f0f0f' }}>
      ...
      <div
        ...
        style={{ width: 260, background: '#111', borderRight: '1px solid #1f1f1f', flexShrink: 0 }}
      >
